...
object InternationalSystemOfUnits {
    ...
    private val Angle = Dimension()
    private val SolidAngle = Dimension()
    ...
    private val Torque = Dimension(L = 2, M = 1, T = -2)
    ...
    private val MagnetomotiveForce = Dimension(I = 1)
    private val MagneticSusceptibility = Dimension(L = -1, M = -1, T = 2, I = 2)
    private val RadiantIntensity = Dimension(L = 2, M = 1, T = -3)
    private val SpectralIntensity = Dimension(L = 1, M = 1, T = -3)
    private val Radiance = Dimension(M = 1, T = -3)
    private val SpectralRadiance = Dimension(L = -1, M = 1, T = -3)
