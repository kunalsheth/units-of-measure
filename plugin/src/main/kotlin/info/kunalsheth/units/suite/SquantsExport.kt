...
object SquantsExport {
    ...
    private val Absement = Dimension(L = 1, T = 1)
    private val AbsorbedDoseRate = Dimension(L = 2, T = -3)
    private val Acceleration = Dimension(L = 1, T = -2)
    private val AngularAcceleration = Dimension(T = -2)
    private val AngularMomentum = Dimension(M = 1, L = 2, T = -1)
    private val AngularVelocity = Dimension(T = -1)
    private val Area = Dimension(L = 2)
    private val AreaDensity = Dimension(M = 1, L = -2)
    private val Capacitance = Dimension(M = -1, L = -2, T = 4, I = 2)
    private val CatalyticActivity = Dimension(T = -1, N = 1)
    private val CatalyticActivityConcentration = Dimension(L = -3, T = -1, N = 1)
    private val ChemicalPotential = Dimension(M = 1, L = 2, T = -2, N = -1)
    private val Crackle = Dimension(L = 1, T = -5)
    private val CurrentDensity = Dimension(L = -2, I = 1)
    private val DoseEquivalent = Dimension(L = 2, T = -2)
    private val DynamicViscosity = Dimension(M = 1, L = -1, T = -1)
    private val ElectricCharge = Dimension(T = 1, I = 1)
    private val ElectricChargeDensity = Dimension(L = -3, T = 1, I = 1)
    private val ElectricDisplacement = Dimension(L = -2, T = 1, I = 1)
    private val ElectricFieldStrength = Dimension(M = 1, L = 1, T = -3, I = -1)
    private val ElectricalConductance = Dimension(M = -1, L = -2, T = 3, I = 2)
    private val ElectricalConductivity = Dimension(M = -1, L = -3, T = 3, I = 2)
    private val ElectricPotential = Dimension(M = 1, L = 2, T = -3, I = -1)
    private val ElectricalResistance = Dimension(M = 1, L = 2, T = -3, I = -2)
    private val ElectricalResistivity = Dimension(M = 1, L = 3, T = -3, I = -2)
    private val Energy = Dimension(M = 1, L = 2, T = -2)
    private val EnergyDensity = Dimension(M = 1, L = -1, T = -2)
    private val Entropy = Dimension(M = 1, L = 2, T = -2, Theta = -1)
    private val Force = Dimension(M = 1, L = 1, T = -2)
    private val Frequency = Dimension(T = -1)
    private val FuelEfficiency = Dimension(L = -2)
    private val HalfLife = Dimension(T = 1)
    private val Heat = Dimension(M = 1, L = 2, T = -2)
    private val HeatCapacity = Dimension(M = 1, L = 2, T = -2, Theta = -1)
    ...
    private val Impulse = Dimension(M = 1, L = 1, T = -1)
    private val Inductance = Dimension(M = 1, L = 2, T = -2, I = -2)
    private val Irradiance = Dimension(M = 1, T = -3)
    private val Intensity = Dimension(M = 1, T = -3)
    private val Jerk = Dimension(L = 1, T = -3)
    private val Snap = Dimension(L = 1, T = -4)
    private val LinearDensity = Dimension(M = 1, L = -1)
    private val LuminousFlux = Dimension(J = 1)
    private val Mach = Dimension(1)
    private val MagneticFieldStrength = Dimension(L = -1, I = 1)
    ...
    private val MassFraction = Dimension(1)
    private val Density = Dimension(M = 1, L = -3)
    private val MeanLifetime = Dimension(T = 1)
    private val MolarConcentration = Dimension(L = -3, N = 1)
    private val MolarEnergy = Dimension(M = 1, L = 2, T = -2, N = -1)
    private val MolarEntropy = Dimension(M = 1, L = 2, T = -2, Theta = -1, N = -1)
    private val MolarHeatCapacity = Dimension(M = 1, L = 2, T = -2, N = -1)
    private val MomentOfInertia = Dimension(M = 1, L = 2)
    private val Momentum = Dimension(M = 1, L = 1, T = -1)
    private val Permeability = Dimension(M = 1, L = 1, T = -2, I = -2)
    private val Permittivity = Dimension(M = -1, L = -3, T = 4, I = 2)
    private val PlaneAngle = Dimension(1)
    private val Power = Dimension(M = 1, L = 2, T = -3)
    private val Pressure = Dimension(M = 1, L = -1, T = -2)
    private val Pop = Dimension(L = 1, T = -6)
    private val RadioactiveActivity = Dimension(T = -1)
    private val RadioactiveDose = Dimension(L = 2, T = -2)
    private val Radiance = Dimension(M = 1, T = -3)
    private val RadiantIntensity = Dimension(M = 1, L = 2, T = -3)
    private val ReactionRate = Dimension(N = 1, L = -3, T = -1)
    private val RefractiveIndex = Dimension(1)
    private val SolidAngle = Dimension(1)
    ...
    private val SpecificVolume = Dimension(M = -1, L = 3)
    private val Spin = Dimension(M = 1, L = 2, T = -1)
    private val Strain = Dimension(1)
    private val Stress = Dimension(M = 1, L = -1, T = -2)
    private val SurfaceTension = Dimension(M = 1, T = -2)
    private val ThermalConductivity = Dimension(M = 1, L = 1, T = -3, Theta = -1)
    private val Torque = Dimension(M = 1, L = 2, T = -2)
    private val Velocity = Dimension(L = 1, T = -1)
    private val Volume = Dimension(L = 3)
    private val Wavelength = Dimension(L = 1)
    private val Wavenumber = Dimension(L = -1)
    private val Wavevector = Dimension(L = -1)
    private val Weight = Dimension(M = 1, L = 1, T = -2)
    private val Work = Dimension(M = 1, L = 2, T = -2)
    private val YoungsModulus = Dimension(M = 1, L = -1, T = -2)
    private val LuminousEnergy = Dimension(T = 1, J = 1)
    private val Luminance = Dimension(L = -2, J = 1)
    private val LuminousEmittance = Dimension(L = -2, J = 1)
    private val LuminousExposure = Dimension(L = -2, T = 1, J = 1)
    private val LuminousEnergyDensity = Dimension(L = -3, T = 1, J = 1)
    private val LuminousEfficacy = Dimension(M = -1, L = -2, T = 3, J = 1)
    private val RadiantEnergy = Dimension(M = 1, L = 2, T = -2)
    private val RadiantEnergyDensity = Dimension(M = 1, L = -1, T = -2)
    private val RadiantFlux = Dimension(M = 1, L = 2, T = -3)
    private val SpectralFlux = Dimension(M = 1, L = 1, T = -3)
    private val SpectralIntensity = Dimension(M = 1, L = 1, T = -3)
    private val SpectralIrradiance = Dimension(M = 1, L = -1, T = -3)
    private val Radiosity = Dimension(M = 1, T = -3)
    private val RadiantExitance = Dimension(M = 1, T = -3)
