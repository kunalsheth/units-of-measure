 ...
 */
interface Measure<This : Measure<This>> : Comparable<This>, Serializable {
    ...
    operator fun rangeTo(that: This) = object : ClosedRange<This> {
        override val start = (this@Measure min that) as This
        override val endInclusive = (this@Measure max that) as This
    }
